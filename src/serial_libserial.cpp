  ...
  try
  {
    switch (baudrate)
    {
      case BAUDRATE::BAUD_4800:
        baud_rate = SerialPort::BAUD_4800;
        break;
      case BAUDRATE::BAUD_9600:
        baud_rate = SerialPort::BAUD_9600;
        break;
      case BAUDRATE::BAUD_19200:
        baud_rate = SerialPort::BAUD_19200;
        break;
      case BAUDRATE::BAUD_38400:
        baud_rate = SerialPort::BAUD_38400;
        break;
      case BAUDRATE::BAUD_57600:
        baud_rate = SerialPort::BAUD_57600;
        break;
      case BAUDRATE::BAUD_115200:
        baud_rate = SerialPort::BAUD_115200;
        break;
      case BAUDRATE ::BAUD_921600:
        baud_rate = SerialPort::BAUD_921600;
        break;
      default:
        throw SerialPort::UnsupportedBaudRate("Not yet implemented baud rate.");
    }

    serial_port_.Open(baud_rate, SerialPort::CHAR_SIZE_8, SerialPort::PARITY_NONE, SerialPort::STOP_BITS_1,
