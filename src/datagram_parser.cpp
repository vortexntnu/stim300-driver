...
void DatagramParser::setDataParameters(SensorConfig sensor_config)
{
  ...
  setDataScales(sensor_config.gyro_output_unit, sensor_config.acc_output_unit, sensor_config.incl_output_unit,
                sensor_config.acc_range);
}
void DatagramParser::setDataScales(GyroOutputUnit gyro_o, AccOutputUnit acc_o, InclOutputUnit incl_o,
                                   AccRange acc_range)
{
  switch (gyro_o)
  {
